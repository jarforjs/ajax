...
define("alinw/switchable/1.0.1/switchable-debug", [ "$-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "alinw/switchable/1.0.1/plugins/effects-debug", "arale/easing/1.0.0/easing-debug", "alinw/switchable/1.0.1/plugins/autoplay-debug", "alinw/switchable/1.0.1/plugins/circular-debug" ], function(require, exports, module) {
    // Switchable
    // -----------
    ...
    var Effects = require("alinw/switchable/1.0.1/plugins/effects-debug");
    var Autoplay = require("alinw/switchable/1.0.1/plugins/autoplay-debug");
    var Circular = require("alinw/switchable/1.0.1/plugins/circular-debug");
...
define("alinw/switchable/1.0.1/plugins/effects-debug", [ "$-debug", "arale/easing/1.0.0/easing-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
        ...
        install: function() {
            ...
            if (effect.indexOf("scroll") === 0) {
                ...
                if (effect === SCROLLX) {
                    ...
                    // 发现上述宽度在Safari下面会出现bug，暂时改为一个比较小的值，后续确定具体数值
...
define("alinw/switchable/1.0.1/plugins/autoplay-debug", [ "$-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var win = $(window);
    // 自动播放插件
    module.exports = {
...
define("alinw/switchable/1.0.1/plugins/circular-debug", [ "$-debug", "alinw/switchable/1.0.1/plugins/effects-debug", "arale/easing/1.0.0/easing-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var SCROLLX = "scrollx";
    var SCROLLY = "scrolly";
    var Effects = require("alinw/switchable/1.0.1/plugins/effects-debug").Effects;
    // 无缝循环滚动插件
    module.exports = {
        // 仅在开启滚动效果时需要
        isNeeded: function() {
