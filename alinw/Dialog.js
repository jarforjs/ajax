...
define("alinw/dialog/2.0.6/dialog-debug", [ "$-debug", "arale/overlay/1.1.4/overlay-debug", "arale/position/1.0.1/position-debug", "arale/iframe-shim/1.0.2/iframe-shim-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "arale/overlay/1.1.4/mask-debug", "arale/templatable/0.9.2/templatable-debug", "gallery/handlebars/1.0.2/handlebars-debug", "./dialog-debug.handlebars" ], function(require, exports, module) {
    ...
    var Dialog = Overlay.extend({
        ...
        _setupMask: function() {
            ...
            this.after("show", function() {
                ...
                mask.set("opacity", .8).set("backgroundColor", "#fff").set("zIndex", that.get("zIndex")).show();
    ...
    module.exports.outerBoxClass = "alinw-dialog-2_0_6";
});

define("alinw/dialog/2.0.6/dialog-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
    ...
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        ...
        buffer += escapeExpression(stack1) + '-close kuma-icon" title="Close" href="javascript:;" data-role="close"></a>\n\n    <div class="';
        if (stack1 = helpers.classPrefix) {
            stack1 = stack1.call(depth0, {
                hash: {},
                data: data
