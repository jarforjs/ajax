 ...
 *
 */
define("alinw/upload/2.1.2/upload-debug", [ "$-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "./form-debug.handlebars", "./blank-iframe-debug.handlebars", "./another-iframe-debug.handlebars", "./data-input-debug.handlebars", "arale/detector/1.3.0/detector-debug" ], function(require, exports, module) {
    "use strict";
    var $ = require("$-debug");
    ...
    var Uploader = Base.extend({
        ...
        rePosition: function() {
            var self = this;
            if (self.get("form")) {
                self.get("form").css(self.getFomStyles());
            }
        },
        setup: function() {
            var self = this;
            ...
            //
            //} else {
            self._detector = setInterval(function() {
        ...
        submit: function() {
            ...
            if (isSupportFormData && self.get("files")) {
                ...
                // fix issue: http://gitlab.alibaba-inc.com/alinw/upload/issues/8
                // var optionXhr = null;
                var optionXhr = jQuery.ajaxSettings.xhr;
        ...
        // fix issue: http://gitlab.alibaba-inc.com/alinw/upload/issues/9
        destroy: function() {
            var self = this;
            if (self._detector) {
                clearInterval(self._detector);
            }
            if (self._detectorFn) {
                //$(document.body).off("DOMSubtreeModified", self._detectorFn);
                self.observer.disconnect();
            }
            if (self.get("iframe")) {
                self.get("iframe").remove();
            }
            if (self.get("form")) {
                self.get("form").remove();
            }
            Uploader.superclass.destroy.call(self);
        }
    });
    module.exports = Uploader;
});

define("alinw/upload/2.1.2/form-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
    ...
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        ...
        buffer += ' title="';
        stack2 = helpers["if"].call(depth0, depth0.title, {
            hash: {},
...
define("alinw/upload/2.1.2/blank-iframe-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
    var Handlebars = require("gallery/handlebars/1.0.2/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [ 3, ">= 1.0.0-rc.4" ];
...
define("alinw/upload/2.1.2/another-iframe-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
    var Handlebars = require("gallery/handlebars/1.0.2/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [ 3, ">= 1.0.0-rc.4" ];
...
define("alinw/upload/2.1.2/data-input-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
    var Handlebars = require("gallery/handlebars/1.0.2/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [ 3, ">= 1.0.0-rc.4" ];
